export const ptBR = {
  ...
  notFound: {
    title: '404 — Página não encontrada · Adryann Felix',
    brandRole: 'ENGENHEIRO DE SOFTWARE',
    cta: 'FALAR COMIGO',
    nav: {
      work: '01_TRABALHOS',
      services: '02_SERVIÇOS',
      process: '03_PROCESSO',
      about: '04_SOBRE',
    },
    errLines: ['ISSO É UM ERRO.', 'A PÁGINA QUE VOCÊ PROCURAVA', 'NÃO EXISTE.'],
    ...
    touchHint: 'Use os controles para jogar',
  },
};
