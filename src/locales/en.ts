export const en = {
  ...
  notFound: {
    title: '404 — Page Not Found · Adryann Felix',
    brandRole: 'SOFTWARE ENGINEER',
    cta: 'GET IN TOUCH',
    nav: {
      work: '01_WORK',
      services: '02_SERVICES',
      process: '03_PROCESS',
      about: '04_ABOUT',
    },
    errLines: ['THAT\'S AN ERROR.', 'THE PAGE YOU WERE LOOKING FOR', 'DOESN\'T EXIST.'],
    ...
    gameOver: 'GAME OVER',
    restart: 'PLAY AGAIN',
    touchHint: 'Use the controls to play',
  },
};
